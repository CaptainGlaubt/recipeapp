...
public class RecipeCommandConverterTest {
    ...
    private RecipeCommandConverter converter;


    @BeforeEach
    public void setUp() throws Exception {
        converter = new RecipeCommandConverter(new CategoryCommandConverter(),
                new IngredientCommandConverter(new UnitOfMeasureCommandConverter()),
                new NotesCommandConverter());
    }
